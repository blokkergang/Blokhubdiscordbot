...
const channel = message.guild.channels.cache.find(ch => ch.name === "test4");
    ...
    .setTitle("**English** These are the most frequently asked questions.")
    .setDescription(" ")
    .setColor("#76c914")
    .addFields(
        {name: "**Whats is the ip from the server?**", value:"the server ip is **play.blokhub.eu** on 1.16.4 t/m 1.17 but we recommend for survival 1.17 and the rest 1.16.4."},
